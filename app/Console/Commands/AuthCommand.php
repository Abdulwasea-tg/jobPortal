...
class AuthCommand extends Command
{
    ...
    protected function exportViews()
    {
        foreach ($this->views as $key => $value) {
            ...
            copy(
                base_path('vendor/laravel/ui/src').'/Auth/'.$this->argument('type').'-stubs/'.$key,
                $view
            );
        }
    }
    ...
    protected function exportBackend()
    {
        ...
        if (! file_exists(database_path('migrations/0001_01_01_000000_create_users_table.php'))) {
            copy(
                base_path('vendor/laravel/ui/src').'/../stubs/migrations/2014_10_12_100000_create_password_resets_table.php',
    ...
    protected function compileStub($stub)
    {
        return str_replace(
            ...
            file_get_contents(base_path('vendor/laravel/ui/src').'/Auth/stubs/'.$stub.'.stub')
        );
    }
