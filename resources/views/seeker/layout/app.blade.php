        ...
        <section class="listing-job">
            <div class="content surface-container-high">
                <div class=" wrapper d-flx-r jc-st flx1 g16 ">
                    ...
                    <nav id="sidenav" class="side-nav pi8 surface-container-low outline-border-r  outline-variant">
                        
                        @include("seeker/layout/includes/menu")
                    </nav>
                    {{-- nav end --}}
                    {{-- main begain --}}
                    <div class="main d-flx-cnw jc-s g16 flx2 p24 surface-container outline-border-r  outline-variant">
