...
<div class="nav">
 ...
 --}}
  <ul class="surface-container icon-nav">
    ...
    <li><a href="{{ route('seeker.document.index')}}"><button id="tab_4" class="btn_tab btn-secondary d-flx flx1" href=""><img src="{{ asset('assets/img/job seeker/application.png')}}" alt="noimg"></img>Documents</button></a></li>
    ...
    <li><a href="{{ route('seeker.feedback.create')}}"><button id="tab_7" class="btn_tab btn-secondary d-flx flx1" href=""><img src="{{ asset('Resorce/user (1).png')}}" alt="noimg"></img>Feedback</button></a></li>
  </ul>
 ...
 --}}  <div id="mySidenav" class="side_nav_box surface-container">
    <a href="javascript:void(0)" id="closebtn" class="closebtn on-surface-container" onclick="closeNav()">&times;</a>
      <ul>
          ...
          <li><a class="on-surface-container" href="{{ route('seeker.document.index')}}"> Documents</a></li>
          <li><a class="on-surface-container" href="{{ route('seeker.applicaions')}}"> Applications</a></li>
          <li><a class="on-surface-container" href="{{ route('seeker.feedback.create')}}"> Feedback</a></li>
